...
for spot in spots:
    ...
    try:
        ...
        # Affichage en 3 colonnes de métriques
        ...
        # Indicateur visuel de praticabilité du vol
        if wind <= 18 and gusts <= 25:
            st.success("✅ **Conditions favorables au vol**")
        elif wind <= 22 and gusts <= 30:
            st.warning("⚠️ **Conditions limites (vent soutenu)**")
        else:
            st.error("❌ **Conditions défavorables (vent fort)**")
